...
### 📊 ผลลัพธ์:
จากกราฟแท่ง (Bar Chart) พบว่าย่านที่มีศักยภาพสูงสุด ได้แก่:
...
## 📌 3: ราคาที่พักต่อคนกับคะแนนรีวิวสัมพันธ์กันหรือไม่?

ต้องการทราบว่าที่พักที่มีราคาต่อคนสูง จะส่งผลต่อคะแนนรีวิวที่ดีขึ้นหรือไม่?

### 📌 ตัวแปรที่ใช้:
- `review_scores_rating`: คะแนนรีวิวจากผู้เข้าพัก
- `price_per_person`: ราคาต่อคน (คำนวณจาก `price ÷ accommodates`)

### 📉 การวิเคราะห์:
ใช้ **Simple Linear Regression** ระหว่าง `price_per_person` กับ `review_scores_rating`

| รายการ                                | คำอธิบาย                                      |
|-------------------------------------|-----------------------------------------------|
| `Equation`      | Price Per Person = `70.29 × Review Score` + `680.58`        |
| `p-value`         | `0.305` ปรากฎให้เห็นถึงไม่ถึงระดับนัยสำคัญ       |
| `R² (อนุมานได้ว่าใกล้ 0)`      | ความสัมพันธ์อ่อนมาก                                  |

### 📈 สรุปผล:
- ความชันบวก → เมื่อคะแนนรีวิวเพิ่ม 1 หน่วย → ราคาต่อคนเพิ่ม ~70 บาท
- แต่ค่า `p-value = 0.305` > 0.05 → **ไม่มีนัยสำคัญทางสถิติ**
- ค่า `R² ≈ 0` → ความสัมพันธ์อ่อนมาก
- ✅ **สรุป:** คะแนนรีวิวไม่ได้ส่งผลต่อราคาต่อคนอย่างมีนัยสำคัญ
